...
//              //  Categoria del Mod
//              WebElement catergoriiiElement = driver.findElement(By.className("project-details-box"));
//
//              List<WebElement> catergori = catergoriiiElement.findElements(By.className("project-categories"));
//
